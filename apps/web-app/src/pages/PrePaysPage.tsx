...
export function PrePaysPage() {
  ...
  const handleSubmit = async () => {
    ...
    console.debug('PrePaysPage handleSubmit payload=', payloadForLog);
    ...
    try {
      ...
      console.error('Error guardando el prepago:', err);
      toast.error(err?.message || 'Error guardando el prepago');
    } finally {
      setSaving(false);
    }
  };
