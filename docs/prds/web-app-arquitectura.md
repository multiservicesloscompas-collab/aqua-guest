...
1. Usuario completa formulario en `WaterSalesPage`
...
2. **WaterSalesPage**: Gestión de ventas de agua
3. **RentalsPage**: Gestión de alquileres de lavadoras
4. **ExpensesPage**: Registro de gastos
5. **ConfigPage**: Configuración de precios y tasa de cambio
6. **CustomersPage**: Gestión de clientes
7. **WashingMachinesPage**: Gestión de lavadoras
8. **PrePaysPage**: Gestión de pedidos prepagados
